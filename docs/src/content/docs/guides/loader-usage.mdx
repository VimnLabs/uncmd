...
## Congratulations!
Now you can use the loader, if you haven't seen how to create commands yet go and check it out:
<LinkCard title="How to create a command" href="/uncmd/guides/command-structure" />